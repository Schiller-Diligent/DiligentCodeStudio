# Diligent Code Studio v0.7.0-dev Cleanup Summary

This clean source package was prepared from `DiligentCodeStudioStarter_v0.7.0-dev_NpmAuditFix.zip`.
...
- Updated `README.md` so it describes v0.7.0-dev instead of v0.6.4.
- Rebuilt `CHANGELOG.md` with v0.7.0-dev first and older details summarized.
...
- Reduced bundled public manuals to the current v0.7.0-dev stable/versioned copies.
- Updated `docs/DiligentCodeStudio_UserManual.pdf` to the v0.7.0-dev stable manual.
- Added the v0.7.0-dev operator/user manual to `docs/manuals/` when available.
