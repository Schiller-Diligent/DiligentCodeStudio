...
export default function App() {
  ...
  log('info', 'Workspace menu button order reset to defaults. Find/Search is available from the Editor quick panel. Find/Search is available from the Editor quick panel. Find/Search is available from the Editor quick panel.');
  }
...
<div className="app-health-strip" aria-label="Project health summary">
  ...
  <span className="tab-close" onClick={(event) => { event.stopPropagation(); closeFile(file.path); }}>x</span>
  </button>
  ))}
  </nav>
